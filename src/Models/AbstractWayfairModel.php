...
/**
 * An Extension of Plenty's Model class which covers the methods that Wayfair does not implement,
 * to allow Wayfair's extensions of Model to be smaller.
 */
abstract class AbstractWayfairModel extends Model
{
