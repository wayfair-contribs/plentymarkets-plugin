...
final class InventoryUpdateServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function dataProviderForTestSync()
    {
        ...
        $cases[] = ["partial syncs are blocked when a partial sync is running v1", null, NoReferencePointForPartialInventorySyncException::class, false, [], [], [], '', '', InventoryStatusService::PARTIAL, self::TIMESTAMP_RECENT];
