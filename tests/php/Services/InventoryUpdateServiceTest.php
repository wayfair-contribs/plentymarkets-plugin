...
final class InventoryUpdateServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    private function createVariationSearchRepositoryFactory(array $variationDataArraysForPages, bool $allItemsActive, bool $shouldStartSyncing): VariationSearchRepositoryFactory
    {
        ...
        $variationSearchRepository = (new MockVariationSearchRepositoryFactory($this))->create($variationDataArraysForPages, $expectedFilters, $expectedSearches);
    ...
    private function createInventoryUpdateService(
        ...
        $variationSearchRepositoryFactory = $this->createVariationSearchRepositoryFactory($variationDataArraysForPages, $allItemsActive, $shouldStartSyncing);
